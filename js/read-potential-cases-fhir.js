...
(async () => {
  ...
  await fs.writeFile("alcoholic-fatty-liver-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("alcoholic-fatty-liver-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
